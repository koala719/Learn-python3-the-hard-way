    ...
    def enter(self):
        ...
        if action == "shoot":
            ...
            print(dedent("""
                  ...
                  pase your head. In the middle of your artful dodge
            ...
            print(dedent("""
                  ...
                  the academy. You tell the one Gothon jokr you know:
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
              ...
              get the bomb out. If you get the code wrong 10 times than
